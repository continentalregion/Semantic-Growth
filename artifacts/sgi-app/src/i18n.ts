  ...
  it: {
    translation: {
      ...
      home: {
        ...
        beginTracking: "Inizia il Tracciamento",
      ...
      leaderboard: {
        ...
        growing: "In crescita",
        yourSgi: "Il tuo SGI",
        sgiDesc: "indice di crescita semantica",
        communityAvg: "Media community",
        aboveAvg: "+{{n}} sopra la media",
        belowAvg: "{{n}} sotto la media",
        totalTracked: "Utenti tracciati",
        inNetwork: "nella rete SGI",
        peakSgi: "Picco assoluto",
        peakDesc: "SGI più alto registrato",
        thresholds: "Soglie di eccellenza",
        reached: "✓ raggiunto",
      ...
      settings: {
        ...
        sgiScore: "SGI Score",
        sgiScoreDesc: "Indice di crescita semantica",
        upgrade: "Upgrade",
        currentPlanBtn: "Piano attuale",
        activateBtn: "Attiva {{name}}",
        ...
        closeBtn: "Chiudi",
        notifyToast: "Ti notificheremo quando il pagamento sarà disponibile!",
        planFeatures: {
          premium: [
      ...
      // Profile
      profile: {
        title: "Profilo di Crescita",
        subtitle: "Milestone, streak e progressi missioni",
        semanticLevel: "Livello Semantico",
        dayStreak: "giorni streak",
        lastActive: "Ultimo accesso: {{date}}",
        ...
        expires: "Scade: {{date}}",
        xpToLevel: "{{n}} XP per il Livello {{next}}",
      },
      // Predictions
      predictions: {
  ...
  en: {
    translation: {
      ...
      leaderboard: {
        ...
        growing: "Growing",
        yourSgi: "Your SGI",
        sgiDesc: "semantic growth index",
        communityAvg: "Community Avg",
        aboveAvg: "+{{n}} above average",
        belowAvg: "{{n}} below average",
        totalTracked: "Tracked Users",
        inNetwork: "in the SGI network",
        peakSgi: "All-Time Peak",
        peakDesc: "highest SGI recorded",
        thresholds: "Excellence Thresholds",
        reached: "✓ reached",
      ...
      settings: {
        ...
        sgiScore: "SGI Score",
        sgiScoreDesc: "Semantic growth index",
        upgrade: "Upgrade",
        currentPlanBtn: "Current Plan",
        activateBtn: "Activate {{name}}",
        ...
        closeBtn: "Close",
        notifyToast: "We'll notify you when payment is available!",
        planFeatures: {
          premium: [
            "600 messages per month",
            "Claude Haiku + Sonnet",
            "Growth predictions (30/90/180 days)",
            "Advanced semantic domain map",
            "90-day SGI history",
            "Detailed monthly report",
          ],
          pro: [
            "2,000 messages per month",
            "All models: Haiku, Sonnet, Opus, GPT-4o",
            "Priority AI access",
            "Unlimited advanced predictions",
            "Full SGI history",
      ...
      profile: {
        ...
        subtitle: "Milestones, streaks, and mission progress",
        semanticLevel: "Semantic Level",
  ...
  es: {
    translation: {
      ...
      home: {
        ...
        beginTracking: "Comenzar Seguimiento",
      ...
      leaderboard: {
        ...
        growing: "Creciendo",
        yourSgi: "Tu SGI",
        sgiDesc: "índice de crecimiento semántico",
        communityAvg: "Media comunidad",
        aboveAvg: "+{{n}} sobre la media",
        belowAvg: "{{n}} bajo la media",
        totalTracked: "Usuarios rastreados",
        inNetwork: "en la red SGI",
        peakSgi: "Pico absoluto",
        peakDesc: "SGI más alto registrado",
        thresholds: "Umbrales de excelencia",
        reached: "✓ alcanzado",
      ...
      settings: {
        ...
        sgiScoreDesc: "Índice de crecimiento semántico",
        upgrade: "Mejorar",
        currentPlanBtn: "Plan actual",
        activateBtn: "Activar {{name}}",
        ...
        closeBtn: "Cerrar",
        notifyToast: "¡Te notificaremos cuando el pago esté disponible!",
        planFeatures: {
          premium: [
            "600 mensajes al mes",
            "Claude Haiku + Sonnet",
            "Predicciones de crecimiento (30/90/180 días)",
            "Mapa avanzado de dominios semánticos",
            "Historial SGI 90 días",
            "Informe mensual detallado",
          ],
          pro: [
            "2.000 mensajes al mes",
            "Todos los modelos: Haiku, Sonnet, Opus, GPT-4o",
            "Acceso prioritario a la AI",
            "Predicciones avanzadas ilimitadas",
            "Historial SGI completo",
            "Exportación de datos y analítica personalizada",
          ],
        },
      ...
      profile: {
        ...
        subtitle: "Hitos, rachas y progreso de misiones",
        semanticLevel: "Nivel Semántico",
        ...
        expires: "Expira: {{date}}",
        xpToLevel: "{{n}} XP para Nivel {{next}}",
      },
      predictions: {
