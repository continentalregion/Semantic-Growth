...
const IT = {
  ...
  home: {
    ...
    live: "Non un chatbot filosofico. Un sistema di misurazione del pensiero.",
    headline: "Parlare di filosofia, lo sanno fare tutti. Misurarla, no.",
    sub: "Conversa su filosofia, scienza ed etica. Ma ogni riflessione diventa anche un punteggio, una sfida, un progresso che vedi crescere — non solo parole che scompaiono nella chat.",
    ...
    verdictTitle: "Verdetto e archetipo",
    verdictDesc: "Un ritratto del tuo modo di pensare, non solo un numero.",
    featuresEyebrow: "Cosa rende SGI diverso da una chat qualsiasi",
  ...
  chat: {
    ...
    upgradeProBtn: "Upgrade a Pro — €29.99",
    upgradePremiumBtn: "Upgrade a Premium — €14.99",
  ...
  howItWorks: {
    ...
    plans: [
      ...
      { name: "Premium", price: "€14.99/mese", features: ["600 messaggi di chat al mese", "80 battaglie al mese", "Claude Haiku + Sonnet", "Predizioni di crescita", "Storico SGI 90 giorni"] },
      { name: "Pro", price: "€29.99/mese", features: ["2.000 messaggi di chat al mese", "250 battaglie al mese", "Tutti i modelli, incluso Opus e GPT-4o", "Accesso prioritario, storico completo, export dati"] },
    ],
...
const EN = {
  ...
  home: {
    ...
    live: "Not a philosophy chatbot. A thinking measurement system.",
    headline: "Talking philosophy, anyone can do that. Measuring it, not quite.",
    sub: "Chat about philosophy, science and ethics. But every reflection also becomes a score, a challenge, a progress you see grow — not just words that vanish into a chat.",
    ...
    verdictTitle: "Verdict and archetype",
    verdictDesc: "A portrait of your way of thinking, not just a number.",
    featuresEyebrow: "What makes SGI different from any chat",
  ...
  chat: {
    ...
    upgradeProBtn: "Upgrade to Pro — €29.99",
    upgradePremiumBtn: "Upgrade to Premium — €14.99",
  ...
  howItWorks: {
    ...
    plans: [
      ...
      { name: "Premium", price: "€14.99/mo", features: ["600 chat messages per month", "80 battles per month", "Claude Haiku + Sonnet", "Growth predictions", "90-day SGI history"] },
      { name: "Pro", price: "€29.99/mo", features: ["2,000 chat messages per month", "250 battles per month", "All models, including Opus and GPT-4o", "Priority access, full history, data export"] },
    ],
...
const ES = {
  ...
  home: {
    ...
    live: "No es un chatbot filosófico. Es un sistema de medición del pensamiento.",
    headline: "Hablar de filosofía, cualquiera puede. Medirla, no.",
    sub: "Conversa sobre filosofía, ciencia y ética. Pero cada reflexión se convierte también en una puntuación, un reto, un progreso que ves crecer — no solo palabras que desaparecen en el chat.",
    ...
    verdictTitle: "Veredicto y arquetipo",
    verdictDesc: "Un retrato de tu forma de pensar, no solo un número.",
    featuresEyebrow: "Qué hace a SGI diferente de cualquier chat",
  ...
  chat: {
    ...
    upgradeProBtn: "Mejorar a Pro — €29.99",
    upgradePremiumBtn: "Mejorar a Premium — €14.99",
  ...
  howItWorks: {
    ...
    plans: [
      ...
      { name: "Premium", price: "€14.99/mes", features: ["600 mensajes de chat al mes", "80 batallas al mes", "Claude Haiku + Sonnet", "Predicciones de crecimiento", "Historial SGI 90 días"] },
      { name: "Pro", price: "€29.99/mes", features: ["2.000 mensajes de chat al mes", "250 batallas al mes", "Todos los modelos, incluido Opus y GPT-4o", "Acceso prioritario, historial completo, exportación de datos"] },
    ],
