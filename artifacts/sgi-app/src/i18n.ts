...
const IT = {
  ...
  home: {
    ...
    headline: "Duella su idee. Misura come pensi.",
    sub: "Scegli un tema di filosofia, scienza o etica. Difendi la tua posizione in 4 mosse — contro un umano o un'AI. L'indice SGI misura profondità, coerenza e originalità del tuo ragionamento, e traccia la crescita nel tempo.",
    ...
    ctaPrimary: "Misura il tuo SGI", ctaSecondary: "Scopri come funziona", ctaGuest: "Prova una battaglia",
...
const EN = {
  ...
  home: {
    ...
    headline: "Debate ideas. Measure how you think.",
    sub: "Pick a theme in philosophy, science, or ethics. Defend your position in 4 moves — against a human or an AI. The SGI index measures depth, coherence and originality of your reasoning, and tracks your growth over time.",
    ...
    ctaPrimary: "Measure your SGI", ctaSecondary: "See how it works", ctaGuest: "Try a battle",
...
const ES = {
  ...
  home: {
    ...
    headline: "Debate ideas. Mide cómo piensas.",
    sub: "Elige un tema de filosofía, ciencia o ética. Defiende tu posición en 4 movimientos — contra un humano o una IA. El índice SGI mide profundidad, coherencia y originalidad de tu razonamiento, y rastrea tu crecimiento a lo largo del tiempo.",
    ...
    ctaPrimary: "Mide tu SGI", ctaSecondary: "Descubre cómo funciona", ctaGuest: "Probar una batalla",
