...
const IT = {
  ...
  home: {
    ...
    sub: "Affronta una battle a turni: scegli il tema, difendi la tua posizione in 4 mosse. L'AI misura in tempo reale profondità, coerenza e originalità del tuo ragionamento — e ti assegna un punteggio che cresce con te.",
  ...
  guestBattle: {
    ...
    placeholder: "Secondo me questo tema è rilevante perché…",
    send: "Invia",
...
const EN = {
  ...
  home: {
    ...
    sub: "Step into a turn-based battle: pick your theme, defend your position in 4 moves. AI scores your reasoning in real time — depth, coherence, originality — and tracks your growth across every conversation.",
  ...
  guestBattle: {
    ...
    theme: "Theme",
    turnN: "Turn {{n}} of {{max}}",
    placeholder: "In my view this topic matters because…",
    send: "Send",
...
const ES = {
  ...
  home: {
    ...
    sub: "Entra en una batalla por turnos: elige el tema, defiende tu posición en 4 movimientos. La IA mide en tiempo real profundidad, coherencia y originalidad de tu razonamiento — y te asigna una puntuación que crece contigo.",
  ...
  guestBattle: {
    ...
    placeholder: "En mi opinión este tema importa porque…",
    send: "Enviar",
