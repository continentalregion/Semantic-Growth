...
const IT = {
  ...
  home: {
    ...
    sub: "Ogni conversazione genera un punteggio. Scopri quanto crescono profondità, varietà e precisione del tuo pensiero — misurati nel tempo, non a sensazione.",
  ...
  guestBattle: {
    ...
    placeholder: "Sviluppa la tua argomentazione…",
    send: "Invia",
...
const EN = {
  ...
  home: {
    ...
    sub: "Every conversation generates a score. See how the depth, variety and precision of your thinking grow — measured over time, not by gut feeling.",
...
const ES = {
  ...
  home: {
    ...
    sub: "Cada conversación genera una puntuación. Descubre cuánto crecen la profundidad, variedad y precisión de tu pensamiento — medido en el tiempo, no a ojo.",
