  ...
  return (
    <div className="space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-4 gap-3">
        {[
          { label: "Level", value: level, color: "#7c6bff" },
          { label: "Total XP", value: xp.toLocaleString(), color: "#06d6a0" },
          { label: "Badges", value: `${earnedBadgeIds.size}/${ALL_BADGES.length}`, color: "#ffbb55" },
          { label: "Rank Δ 30d", value: rankChange > 0 ? `+${rankChange}` : rankChange === 0 ? "—" : `${rankChange}`, color: rankChange > 0 ? "#06d6a0" : rankChange < 0 ? "#f72585" : "#9090b8" },
        ].map((stat) => (
          <div
            key={stat.label}
          ...
          >
            ...
            {stat.label === "Level" && (
              <div className="text-[11px] mt-1" style={{ color: "rgba(144,144,184,1)" }}>
                Semantic Level
              </div>
            )}
          </div>
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <div className="space-y-0">
              {missions.length === 0 ? (
                <p className="text-xs" style={{ color: "rgba(144,144,184,1)" }}>
                ...
                missions.slice(0, 5).map((m) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="text-[12px] leading-snug truncate" style={{ color: "#eeeeff" }}>
                        {m.title}
                      </div>
                      {!m.completed && (m.target ?? 0) > 1 && (
                        <div className="text-[10px]" style={{ color: "rgba(144,144,184,0.7)" }}>
          ...
          >
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[10px]" style={{ color: "rgba(144,144,184,1)" }}>days</span>
              </div>
            </div>
            <div
            ...
            >
              {streakDays.map((active, i) => (
                <div
                  ...
                  style={{
                    background: active
                      ? `rgba(124,107,255,${0.4 + (i / 21) * 0.6})`
                      : "rgba(255,255,255,0.04)",
                  }}
                />
              ))}
            </div>
            <div className="text-[10px] mt-2" style={{ color: "rgba(74,74,106,1)" }}>
              Last 21 days
            </div>
          </div>
        </div>
