        ...
        <Card className="bg-card/50 backdrop-blur border-primary/20">
          <CardContent className="flex flex-col items-center justify-center py-24 gap-4 text-center">
            ...
            <p className="text-muted-foreground max-w-md">
              The interactive Semantic Map shows your full domain network, cross-discipline connections, and exploration depth.
      ...
      {nodes.length === 0 ? (
        <Card className="bg-card/50 backdrop-blur">
          <CardContent className="flex flex-col items-center justify-center py-24 text-center gap-4">
            <p className="text-muted-foreground">Start conversations to build your semantic domain map.</p>
          </CardContent>
        </Card>
      ) : (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <Card className="bg-card/50 backdrop-blur">
            <CardHeader>
              <CardTitle>Domain Network</CardTitle>
              <p className="text-xs text-muted-foreground">Node size = exploration score · Edge thickness = cross-domain strength</p>
            </CardHeader>
            <CardContent>
          ...
          <Card className="bg-card/50 backdrop-blur">
            <CardHeader>
              ...
              <p className="text-xs text-muted-foreground">Score 0–10 per domain</p>
            </CardHeader>
            <CardContent>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                {nodes.map(n => (
                  <div key={n.id} className="rounded-lg bg-slate-900/60 border border-white/5 p-3 flex flex-col gap-1">
                    ...
                    <div className="text-xs text-muted-foreground">{n.messageCount} msgs</div>
                  </div>
                ))}
              </div>
            </CardContent>
